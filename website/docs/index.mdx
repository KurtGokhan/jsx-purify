...
To use JSX Middlewares, you need to setup your JSX transpiler to use the `jsx-purify/react` package as the JSX factory. This is done differently depending on the transpiler you are using.
